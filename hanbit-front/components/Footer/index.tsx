        ...
        <div className={styles.footer}>
            <div className={styles.footer_container}>
                <div className={styles.footer_inner_container_left}>
                    ...
                    <div className={styles.footer_menu_3}>대표: 임원재 | 주소: 대전광역시 유성구 원내동 296-9(홈데코갤러리 1층) | 사업자등록번호: 768-15-01230</div>
                    <div className={styles.footer_menu_4}>스토리 창은 기쁨과 감동을 드리는 커튼블라인드 기업입니다.</div>
                </div>
