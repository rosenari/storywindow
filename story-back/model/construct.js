...
module.exports = (function () {
    ...
    construct.getLikeConstructs = (req, res, errhandler) => {
        let sql = `select c.id,c.title,c.contents,c.tags,c.space,c.views,c.date,c.mainimage,c.thumbnail,COUNT(cl.construct_id) as 'like'
         from construct as c left outer join construct_like as cl
         on c.id = cl.construct_id
         group by c.id
         order by COUNT(cl.construct_id) desc
         limit 0,6;`
